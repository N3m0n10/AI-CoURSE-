...
L = 32
iters = 500
version = "0.41 - TOURNAMENT - bad child replacement"
...
def crossover(crom1, crom2): 
    ...
    # Replace child with worst fitness father if both worse than the worst parent
    if fit_child1 and fit_child2 < parent_min:
