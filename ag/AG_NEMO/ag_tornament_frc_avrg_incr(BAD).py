...
population_size = 200
mutation_rate = 0.01
pc = 0.96 ##crossover rate
L = 32
iters = 600
version = "0.42 - TOURNAMENT - force average +"
...
for q in range(iters):
    ...
    # Calculate new generation's average fitness
    new_total_fitness = sum(get_fitness(new_population))
    new_average_fitness = new_total_fitness/len(new_population)
    
    # Only update population if new average is better
