(define (problem p4) (:domain ex_3_optic)
(:objects 
    b - barist
...
(:init
    ...
    (not-drink-in-tray d3) (not-drink-in-tray d4)
    (not-drink-in-tray d5) (not-drink-in-tray d6)
    (not-drink-in-tray d7) (not-drink-in-tray d8)
    (barist-available b)
    ...
    (needs-cleaning t2)
    (=(client-on-table t4)2.0) (=(client-on-table t1)2.0) (=(client-on-table t3)4.0) (=(client-on-table t2)0)
    (=(client-served t4)0) (=(client-served t1)0) (=(client-served t3)0) (=(client-served t2)0)
    (=(drinks-in-tray)0)
    (=(table-size t1)1.0) (=(table-size t2)1.0) (=(table-size t3)2.0) (=(table-size t4)1.0)
    (=(distance balcao t1)2.0) (=(distance t1 balcao)2.0)
    (=(distance balcao t2)2.0) (=(distance t2 balcao)2.0)
    (=(distance balcao t3)3.0) (=(distance t3 balcao)3.0)
    (=(distance balcao t4)3.0) (=(distance t4 balcao)3.0)
    (dirty-trigger t1) (dirty-trigger t2) (dirty-trigger t3) (dirty-trigger t4)
)
