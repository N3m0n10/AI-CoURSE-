...
(:requirements :strips :fluents :numeric-fluents :typing :equality :duration-inequalities :action-costs :durative-actions :quantified-preconditions :conditional-effects)
