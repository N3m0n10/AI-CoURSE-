(define (problem p3) (:domain ex_3_optic)
(:objects 
    b - barist
    d1 d2 d3 d4 - drink
    w - waiter
...
(:init
    ...
    (needs-cleaning t3) 
    ;;
    (=(client-on-table t2)0) (=(client-served t2)0)
    (=(client-on-table t1)2) (=(client-served t1)0)
    (=(client-on-table t3)0) (=(client-served t3)0)
    (=(client-on-table t4)2) (=(client-served t4)0)
    (=(drinks-in-tray)0)
    ...
    (dirty-trigger t1) (dirty-trigger t4)
)
