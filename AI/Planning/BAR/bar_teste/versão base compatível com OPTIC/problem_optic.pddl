(define (problem p4) (:domain d_optic)
(:objects 
    b - barist
...
(:init
    ...
    (=(distance-b-t balcao t1)2) (=(distance-t-b t1 balcao)2)
    (=(distance-b-t balcao t2)2) (=(distance-t-b t2 balcao)2)
    (=(distance-b-t balcao t3)3) (=(distance-t-b t3 balcao)3)
    (=(distance-b-t balcao t4)3) (=(distance-t-b t4 balcao)3)
)
