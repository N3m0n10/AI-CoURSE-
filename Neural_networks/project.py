...
import sys
import os
sys.dont_write_bytecode = True   # block pycache
...
theta2 = np.random.rand(2,2) * 2 * init_epsilon - init_epsilon
theta3 = np.random.rand(1,2) * 2 * init_epsilon - init_epsilon
...
error = J(prediction, Y, lbd=0)  # no regularization
print(result)
print(error)