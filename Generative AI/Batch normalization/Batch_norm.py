...
class Dropout_BN_CNN(nn.Module):
    def __init__(self):
        super(Dropout_BN_CNN, self).__init__()

        # Convolution layer 1
        self.conv1 = nn.Conv2d(in_channels=1, out_channels=32,
        kernel_size=3, stride=1, padding=1)
        self.bn1 = nn.BatchNorm2d(32) # BatchNorm for the first convol. layer

        # Convolution layer 2
        self.conv2 = nn.Conv2d(in_channels=32, out_channels=64,
        kernel_size=3, stride=1, padding=1)
        self.bn2 = nn.BatchNorm2d(64) # BatchNorm for the second convol.
...
#TODO: compare inputs in with different methods
# using smaller examples